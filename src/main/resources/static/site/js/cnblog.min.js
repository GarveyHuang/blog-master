...
function PostNewComment(articleId) {
    ...
    $.ajax({
        ...
        success: function (n) {
            if (n)
                n.code=="success" ? (ShowCommentMsg("评论提交成功，感谢您的回复"), $("#tbCommentBody").val(""), $("#divCommentShow").html($("#divCommentShow").html() + n.Message), cb_mathjax_render("#divCommentShow")) : ShowCommentMsg(n.Message), $("#btn_comment_submit").removeAttr("disabled");
            else
                ShowCommentMsg("抱歉！评论提交失败！请与管理员联系(ishuangjw@foxmail.com)。"), $("#btn_comment_submit").removeAttr("disabled")
        },
        error: function (n, t) {
            n.code=="fail" ? ShowCommentMsg("抱歉！发生了错误！麻烦反馈至ishuangjw@foxmail.com"):$("#btn_comment_submit").removeAttr("disabled");
        }
    })
};
