...
<head>
    ...
    <title>登录</title>
    <script
            src="${pageContext.request.contextPath}/plugins/bootstrap3/js/jquery-1.11.2.min.js"></script>
    <style>
        body {
            background: #ebebeb;
...
<form id="loginForm" method="post" onsubmit="return checkForm()">
    <div style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
        ...
        <p style="padding: 30px 0px 10px; position: relative;">
            ...
            <input id="username" name="username" class="ipt" type="text" placeholder="请输入用户名" required="" value="${blogger.username}">
        </p>
        <p style="position: relative;">
            <span class="p_logo"></span>
            <input id="password" name="password" class="ipt" type="password" placeholder="请输入密码" required="" value="${blogger.password}">
        </p>
        <p style="position: relative;">
