...
_37(tr2,_36);
function _37(tr,_38){
$("<tr class=\"treegrid-tr-tree\">"+"<td styles=\"border:0px\" colspan=\""+_38+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
...
_c7.push("<tr class=\"treegrid-tr-tree\"><td styles=\"border:0px\" colspan="+(_be.length+(_bd.rownumbers?1:0))+"><div styles=\"display:"+v+"\">");
_c7=_c7.concat(tt);
_c7.push("</div></td></tr>");
}
}
...
var _d9=col.hidden?"styles=\"display:none;"+_d8+"\"":(_d8?"styles=\""+_d8+"\"":"");
