...
$(ss.join("\n")).appendTo(cc);
setTimeout(function(){
cc.children("styles:not(:last)").remove();
},0);
},getRule:function(_f){
var _10=cc.children("styles:last")[0];
...
$("<div class=\"datagrid-mask\" styles=\"display:block\"></div>").appendTo(_1bc);
var msg=$("<div class=\"datagrid-mask-msg\" styles=\"display:block;left:50%\"></div>").html(opts.loadMsg).appendTo(_1bc);
...
var _1f6=col.hidden?"styles=\"display:none;"+_1f5+"\"":(_1f5?"styles=\""+_1f5+"\"":"");
