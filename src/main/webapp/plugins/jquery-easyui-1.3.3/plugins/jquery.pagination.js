...
bb.prev=_6("prev");
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
$("<span styles=\"padding-left:6px;\"></span>").html(_4.beforePageText).appendTo(tr).wrap("<td></td>");
...
bb.after=$("<span styles=\"padding-right:6px;\"></span>").appendTo(tr).wrap("<td></td>");
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
bb.next=_6("next");
bb.last=_6("last");
if(_4.showRefresh){
...
$("<div styles=\"clear:both;\"></div>").appendTo(_5);
};
function _b(_c,_d){
