...
var _20=_1f[i];
_1d.push("<div class=\"datagrid-group\" group-index="+i+" styles=\"height:25px;overflow:hidden;border-bottom:1px solid #ccc;\">");
_1d.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" styles=\"height:100%\"><tbody>");
_1d.push("<tr>");
_1d.push("<td styles=\"border:0;\">");
if(!_18){
_1d.push("<span styles=\"color:#666;font-weight:bold;\">");
...
$("<td styles=\"border:0;text-align:center;width:25px\"><span class=\"datagrid-row-expander datagrid-row-collapse\" styles=\"display:inline-block;width:16px;height:16px;cursor:pointer\">&nbsp;</span></td>").insertBefore(_29.find("td"));
